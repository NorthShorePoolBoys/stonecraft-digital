...
const Header = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-[100] flex justify-between items-center <nav className="fixed top-0 left-0 right-0 z-[100] flex justify-between items-center px-2 py-0 md:px-6 md:py-0 bg-charcoal/[.97] backdrop-blur-[10px] border-b-2 border-accent"> bg-charcoal/[.97] backdrop-blur-[10px] border-b-2 border-accent">
      <Link to="/">
        <img src={logo} alt="New England Pavers & Stone" className="<img src={logo} alt="New England Pavers & Stone" className="h-64 md:h-80 w-auto" /> w-auto" />
      </Link>
